...
otfm = GENOT(neural_net, bridge_net=bridge_net, ot_solver=ot_solver, epsilon=1e-2, scale_cost="mean", input_dim=30, output_dim=30, iterations=10_000, k_noise_per_x=1)
